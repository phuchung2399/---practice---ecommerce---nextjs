    ...
    <li className=" bg-[#F6F5F3] dark:bg-[#484848] shadow-md overflow-hidden dark:text-slate-900">
      ...
      <div className="relative w-full h-[250px] group ">
        ...
        <Link href={`/${category}/${id}`} passHref>
          <a className="absolute opacity-0 transition duration-300 z-10 group-hover:opacity-100 py-2 px-5 border-2 font-normal border-white-color text-white-color top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center cursor-pointer shadow-md">
            View product
          </a>
        </Link>
