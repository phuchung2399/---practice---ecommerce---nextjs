...
export default function ImageSearchBar() {
  ...
  return (
    ...
    "
    >
      <div className="flex max-w-[500px] ml-auto relative overflow-x-hidden overflow-y-hidden">
        <input
          type="search"
          className="appearance-none outline-none focus:outline-none border-2 border-gray-200 
          -mr-16 font-jakart py-[3px] px-7 text-sm bg-transparent  peer  flex-1
      ...
      py-2 px-3 
      lg:py-0 lg:px-1
      bg-gradient-to-t bg-primary-color z-10 to-[#fecd48]
